    ...
    class Cat
    {
        ...
        public double Energy
        {
            ...
            set
            {
                if (value < MinEnergy)
                {
                    var ex = new Exception("Not enough energy to jump");
                    throw ex;
                }
                else _energy = Math.Min(value, MaxEnergy);
            }
        }
        ...
        public void Jump() => Energy = Energy - JumpEnergyDrain;

        public void Sleep() => Energy = Energy + SleepEnergyGain;
    }
}